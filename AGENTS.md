...
Rove Code is a minimal GUI for coding agents. A Node WebSocket server wraps provider CLIs (Codex, Claude Code, Cursor, Grok, OpenCode) and serves web, desktop, and mobile clients.
...
- **we, us, and maintainers** mean the people building Rove Code. These are who you are talking to now.
