...
function normalizeCodexTokenUsage(
  ...
  const cacheCreationTokens = usage.last.cacheWriteInputTokens;
  ...
  return {
    ...
    ...(cacheCreationTokens !== undefined ? { lastCacheCreationTokens: cacheCreationTokens } : {}),
...
export const makeCodexAdapter = Effect.fn("makeCodexAdapter")(function* (
  ...
  const uploadFeedback: CodexAdapterContract["uploadFeedback"] = (input) =>
