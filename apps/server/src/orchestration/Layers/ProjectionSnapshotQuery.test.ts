    ...
    Effect.gen(function* () {
      ...
      yield* sql`
        ...
        VALUES
          (
            ...
            'rovecode/rove',
            41,
            'https://github.com/rovecode/rove/pull/41',
            'created',
      ...
      yield* sql`
        ...
        VALUES (
          ...
          NULL,
          NULL,
          '{"projectId":"project-1","repository":"rovecode/rove","number":41,"url":"https://github.com/rovecode/rove/pull/41"}',
      ...
      const expectedPullRequests: ReadonlyArray<ThreadPullRequestLink> = [
        {
          ...
          repository: "rovecode/rove",
          number: 41,
          url: "https://github.com/rovecode/rove/pull/41",
          source: "created",
