    ...
    Effect.gen(function* () {
      ...
      yield* sql`
        ...
        VALUES
          (
            ...
            'rovedev/rove',
            41,
            'https://github.com/rovedev/rove/pull/41',
            'created',
      ...
      yield* sql`
        ...
        VALUES (
          ...
          NULL,
          NULL,
          '{"projectId":"project-1","repository":"rovedev/rove","number":41,"url":"https://github.com/rovedev/rove/pull/41"}',
      ...
      const expectedPullRequests: ReadonlyArray<ThreadPullRequestLink> = [
        {
          ...
          repository: "rovedev/rove",
          number: 41,
          url: "https://github.com/rovedev/rove/pull/41",
          source: "created",
