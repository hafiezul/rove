  ...
  it.effect("links the same Forgejo number on two ports and unlinks an older portless record", () =>
    Effect.gen(function* () {
      ...
      const command = yield* decodeCommand({
        ...
        repository: "t3tools/rove",
        number: 42,
        url: "http://forge.example:4000/t3tools/rove/pulls/42",
        source: "manual",
      });
  ...
  it.effect("legacy unlink cannot remove a newer cross-host link", () =>
    Effect.gen(function* () {
      ...
      const foreign = makeLink({
        ...
        url: "https://github.enterprise.test/t3tools/rove/pull/42",
    ...
    Effect.gen(function* () {
      ...
      const command = yield* decodeCommand({
        ...
        linkedPullRequest: {
          ...
          repository: "t3tools/rove",
          number: 99,
          url: "https://github.com/t3tools/rove/pull/99",
        },
      });
