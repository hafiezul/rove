...
declare const __ROVE_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __ROVE_BUILD_CHANNEL__ === "undefined" ? "dev" : __ROVE_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "Rove Code (Dev)",
  nightly: "Rove Code (Nightly)",
  latest: "Rove Code",
...
<html lang="en">
  <head>
    ...
    <title>Rove Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up Rove Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
