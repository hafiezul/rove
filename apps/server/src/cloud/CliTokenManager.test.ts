...
const TEST_ENV = {
  ROVE_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  ROVE_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  ROVE_HOSTED_APP_URL: "https://hosted.example.test",
};
