  ...
  it.effect("carries every repository and every qualifier into one search", () =>
    Effect.gen(function* () {
      ...
      yield* cli.searchPullRequests({
        cwd: "/w",
        host: "github.com",
        repositories: ["acme/web", "rovecode/rove"],
        state: "closed",
        involvement: "reviewing",
        viewer: "bilal",
        limit: 10,
      ...
      assert.strictEqual(
        ...
        'is:pr is:closed is:unmerged review-requested:bilal "pull requests page" ' +
          "updated:<=2026-07-02T00:00:00Z sort:updated-desc repo:acme/web repo:rovecode/rove",
      );
    }),
  );
    ...
    Effect.gen(function* () {
      mockedExecute.mockReturnValue(
        Effect.succeed(
          searchPage([
            ...
            searchItem(9, "rovecode/rove", "2026-07-02T00:00:00Z"),
      ...
      assert.deepStrictEqual(
        ...
        [
          ...
          ["rovecode/rove", 9, "https://avatars/octocat"],
        ],
      );
