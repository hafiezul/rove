...
export function RoveConnectEnvironmentRow(props: {
          ...
          <div className="pt-3">
            ...
            >
              ...
              <p className="mt-4 max-w-xl text-[0.8125rem] leading-[1.125rem] text-muted-foreground">
                Rove Connect access will be revoked, any managed tunnel will be removed, and a host
...
export function RoveConnectUserProfilePage() {
  ...
  const handleDeregister = async (environment: RelayClientEnvironmentRecord) => {
    ...
    if (result._tag === "Success") {
      ...
      toastManager.add({
        ...
        description: "Rove Connect access was revoked and a host space is now available.",
      });
      return;
    }
