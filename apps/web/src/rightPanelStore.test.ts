...
describe("rightPanelStore", () => {
  ...
  it("tracks one surface per pull request", () => {
    const first = { projectId: "project-a", repository: "rovecode/rove", number: 4909 };
    const second = { projectId: "project-a", repository: "rovecode/rove", number: 4910 };
    useRightPanelStore.getState().openPullRequest(refA, first);
    useRightPanelStore.getState().openPullRequest(refA, second);
    const url = "https://gitlab.example.com/rovecode/rove/-/merge_requests/4909";
