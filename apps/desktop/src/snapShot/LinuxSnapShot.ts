...
const EXTENSION = "io.github.hafiezul.rove.ShellSnapShot";
const EXTENSION_PATH = "/io/github/hafiezul/rove/ShellSnapShot";
...
export class LinuxCaptureConnection {
  ...
  async captureExtension(appId: string, options?: FeedbackOptions): Promise<LinuxWindowSnapshot> {
    ...
    if (result !== RequestNameReply.PRIMARY_OWNER) {
      throw new Error("Another Rove Code instance is capturing a window. Try again.");
    }
