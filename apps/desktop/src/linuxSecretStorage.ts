...
function getGnomeKeyringRemediationMessage(): string {
  return "Rove could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Rove.";
}

function getKWalletRemediationMessage(): string {
  return "Rove could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Rove.";
}
