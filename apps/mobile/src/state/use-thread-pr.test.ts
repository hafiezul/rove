...
const pullRequest: NonNullable<VcsStatusResult["pr"]> = {
  ...
  url: "https://github.com/t3tools/rove/pull/3774",
  baseRef: "main",
...
describe("resolveThreadPrSource compatibility", () => {
  const legacyRef = {
    ...
    repository: "t3tools/rove",
    number: 1,
    url: "https://github.com/t3tools/rove/pull/1",
  };
  const branchRef = { ...legacyRef, number: 2, url: "https://github.com/t3tools/rove/pull/2" };
