...
/**
 * Decouples a provider's bursty token cadence from expensive native markdown
 * and list rendering. Source text remains authoritative; only an append-only
 * live prefix is paced, and completed or replacement text is shown immediately.
 */
