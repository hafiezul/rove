...
const ThreadTokenUsageSharedFields = {
  ...
  /** Counters may describe one response or the full active branch, not necessarily this window. */
  tokenBreakdownScope: Schema.optional(Schema.Literals(["latestResponse", "activeBranch"])),
...
export const UserInputQuestion = Schema.Struct({
  ...
  inputMode: Schema.optional(Schema.Literal("multiline")),
