 ...
 * machine into a Rove Code browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** Rove Code profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give Rove Code Full Disk Access in System Settings → Privacy & Security, then retry.",
