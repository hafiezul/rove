...
export const ServerProvider = Schema.Struct({
  ...
  // Whether the provider can honor changes to the generic access mode.
  runtimeModeSelectable: Schema.optional(Schema.Boolean),
...
/**
 * A palette the environment's machine publishes for Rove Code to follow, read
 ...
 * over as a coherent Rove Code palette instead of a foreign one.
 */
