...
the software keyboard, and supplies deterministic Rove Connect discovery rows to the real
...
The Pending rows use the production offline outbox and point at the real Rove Code and React fixture
