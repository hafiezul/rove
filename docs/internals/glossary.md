...
Terms whose meaning matters across Rove. Architecture and lifecycle constraints belong in the
...
| Term                | Meaning                                                                                                      |
| ------------------- | ------------------------------------------------------------------------------------------------------------ |
| Provider            | The agent runtime Rove controls, such as Codex or Claude Code.                                            |
...
| Adapter             | The boundary translating a provider's native protocol into Rove operations and events.                    |
