...
Tailscale, SSH, and Rove Connect change how the client reaches that server; they do
...
[Rove Connect trust boundary](./rove-connect.md).
...
connect. This is possible because the desktop renderer is not served by the backend: the `rove://`
