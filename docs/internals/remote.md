...
| `RelayConnectionTarget`   | Managed Rove Connect relay tunnels.                                      |
...
Managed Rove Connect relay tunnels use `RelayConnectionTarget` and are the answer when the host is
...
Worker itself. See [rove-connect.md](./rove-connect.md).
...
- a relay-hosted OAuth callback broker (see [rove-connect.md](./rove-connect.md));
