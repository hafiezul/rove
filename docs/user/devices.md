...
`agent-device` command line, which Rove Code sets up for them.
...
Studio's Device Manager. Rove Code detects standard SDK locations; set
...
local network, Tailscale, and Rove Connect. Live video needs a secure page
