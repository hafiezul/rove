...
When you change a new thread's project, Rove stays in the current environment
...
If dragging is unavailable for one environment, update the Rove server running in that
